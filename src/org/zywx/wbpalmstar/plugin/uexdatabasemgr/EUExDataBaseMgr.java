...
public class EUExDataBaseMgr extends EUExBase {
	...
	public void transactionOnThread(String[] params)
	{
		Gson gson=new Gson();
		DataBaseVO dataBaseVO = gson.fromJson(params[0], DataBaseVO.class);
		
        String[] sqls = gson.fromJson(params[1], new TypeToken<String[]>() {
        }.getType());
